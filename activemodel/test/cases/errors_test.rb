...
class ErrorsTest < ActiveModel::TestCase
  ...
  test "full_message returns the given message when message_without_attribute is passed in" do
    person = Person.new
    assert_equal "cannot be blank", person.errors.full_message(:name, "cannot be blank", message_without_attribute: true)
    assert_equal "cannot be blank", person.errors.full_message(:name_test, "cannot be blank", message_without_attribute: true)
  end
